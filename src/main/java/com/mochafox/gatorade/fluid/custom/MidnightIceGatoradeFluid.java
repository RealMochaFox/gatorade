...
/**
 * Fluid representing midnight ice flavored gatorade.
 */
public class MidnightIceGatoradeFluid extends GatoradeFluid.SourceGatoradeFluid {
    public static final String NAME = "midnight_ice_gatorade";

    private static final GatoradeFluid.FluidRegistrySet<MidnightIceGatoradeFluid> REGISTRY_SET = 
        GatoradeFluid.registerFluidSet(NAME, 
            () -> new MidnightIceGatoradeFluid(getProperties()),
    ...
    public static final DeferredHolder<Fluid, MidnightIceGatoradeFluid> SOURCE = REGISTRY_SET.source;
    ...
    public MidnightIceGatoradeFluid(BaseFlowingFluid.Properties properties) {
        super(properties);
    }

    @Override
    public int getTintColor() {
        return 0xBB200040; // dark purple with water-level transparency
    }
}
