...
/**
 * Fluid representing blue cherry flavored gatorade.
 */
public class BlueCherryGatoradeFluid extends GatoradeFluid.SourceGatoradeFluid {
    public static final String NAME = "blue_cherry_gatorade";

    private static final GatoradeFluid.FluidRegistrySet<BlueCherryGatoradeFluid> REGISTRY_SET = 
        GatoradeFluid.registerFluidSet(NAME, 
            () -> new BlueCherryGatoradeFluid(getProperties()),
    ...
    public static final DeferredHolder<Fluid, BlueCherryGatoradeFluid> SOURCE = REGISTRY_SET.source;
    ...
    public BlueCherryGatoradeFluid(BaseFlowingFluid.Properties properties) {
        super(properties);
    }

    @Override
    public int getTintColor() {
        return 0x664060ff; // blue-purple with water-level transparency
    }
}
