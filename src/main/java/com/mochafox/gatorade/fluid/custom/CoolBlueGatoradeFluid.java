...
/**
 * Fluid representing cool blue flavored gatorade.
 */
public class CoolBlueGatoradeFluid extends GatoradeFluid.SourceGatoradeFluid {
    public static final String NAME = "cool_blue_gatorade";

    private static final GatoradeFluid.FluidRegistrySet<CoolBlueGatoradeFluid> REGISTRY_SET = 
        GatoradeFluid.registerFluidSet(NAME, 
            () -> new CoolBlueGatoradeFluid(getProperties()),
            1050,
            1200,
            295
        );
    ...
    public static final DeferredHolder<Fluid, CoolBlueGatoradeFluid> SOURCE = REGISTRY_SET.source;
    ...
    public CoolBlueGatoradeFluid(BaseFlowingFluid.Properties properties) {
        super(properties);
    }

    @Override
    public int getTintColor() {
        return 0xff0080ff; // cool blue with full alpha
    }
}
